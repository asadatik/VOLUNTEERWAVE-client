    ...
    return (
        <div className="hero  rounded-3xl  "  style={{backgroundImage: 'url(https://i.ibb.co/7Nntrwf/user-typing-login-and-password-cyber-security-concept-1.jpg)'}}  > 
            <div className="hero-content  flex-col lg:flex-row">
                 ...
                 <div>
                 <div className=' px-6 py-4  md:px-8 bg-base-100'>
                  
          <p className='mt-3 text-3xl font-bold text-center text-sky-600  '>
            Please Login Here!
          </p>

          <div
            onClick={handleGoogleSignIn}
            className='flex cursor-pointer items-center justify-center mt-4 transition-colors duration-300 transform border rounded-lg bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-300 hover:to-yellow-200 ...'
          >
